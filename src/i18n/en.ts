...
export const en: Translations = {
  ...
  profile: {
    ...
    publicProfileDesc: 'Allow others to find you in search',
  ...
  notifications: {
    ...
    inboxFull: 'Your inbox is full',
    markAllRead: 'Mark all as read',
    viewAll: 'View all',
  },
  featureDescriptions: {
    inbox: 'Manage your messages organized in three categories: Work, Audience, and Direct.',
    search: 'Find users and send them messages directly.',
    patterns: 'Visualize your communication patterns with interactive charts.',
    profile: 'Customize your personal information and profile photo.',
    darkMode: 'Switch between light and dark mode for visual comfort.',
    languages: 'Choose your preferred language: Arabic, English, French, or Spanish.',
    notifications: 'Receive instant alerts for new messages and full inbox.',
    directAccess: 'Control who can send you direct messages.',
    messageLimit: 'Set how many messages you can receive in each category.',
  },
};
