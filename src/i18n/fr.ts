...
export const fr: Translations = {
  ...
  profile: {
    ...
    publicProfileDesc: 'Permettre aux autres de vous trouver',
  ...
  notifications: {
    ...
    inboxFull: 'Votre boîte est pleine',
    markAllRead: 'Tout marquer comme lu',
    viewAll: 'Voir tout',
  },
  featureDescriptions: {
    inbox: 'Gérez vos messages organisés en trois catégories: Travail, Audience et Direct.',
    search: 'Trouvez des utilisateurs et envoyez-leur des messages.',
    patterns: 'Visualisez vos tendances de communication avec des graphiques.',
    profile: 'Personnalisez vos informations personnelles et votre photo.',
    darkMode: 'Basculez entre mode clair et sombre pour le confort visuel.',
    languages: 'Choisissez votre langue: Arabe, Anglais, Français ou Espagnol.',
    notifications: "Recevez des alertes instantanées pour les nouveaux messages.",
    directAccess: 'Contrôlez qui peut vous envoyer des messages directs.',
    messageLimit: 'Définissez le nombre de messages par catégorie.',
  },
};
